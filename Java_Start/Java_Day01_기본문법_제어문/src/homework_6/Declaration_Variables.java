...
public class Declaration_Variables {
	public static void main(String[] args) {
		
		/* 기본형(Primitive Type) 연습하기 */

		// Q. 1 Byte 는 몇 Bit 인가요?
		System.out.println("1 Byte는 " + 8 + " Bit 입니다.");
		...
		// Q. 0부터 65536까지 저장할 수 있는 데이터 타입을 선언해 봅시다.
		//    \u0000부터 \uffff로 저장할 수 있습니다.
		char value5 = '\u0041';
		...
		System.out.printf("int형 변환이 이루어진 value13의 값: %2d", value13);
